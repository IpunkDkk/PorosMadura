...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_ads_status" AS ENUM('draft', 'active', 'inactive');
  CREATE TYPE "public"."enum_ad_slots_fallback_type" AS ENUM('none', 'adsense');
  CREATE TYPE "public"."enum_ad_events_event_type" AS ENUM('impression', 'click');
  ...
  CREATE TABLE "_posts_v" (
  	...
  	"version_is_breaking_news" boolean DEFAULT false,
  ...
  CREATE TABLE "ads" (
  	...
  	"status" "enum_ads_status" DEFAULT 'draft',
  ...
  CREATE TABLE "ad_slots" (
  	...
  	"description" varchar,
  	"fallback_type" "enum_ad_slots_fallback_type" DEFAULT 'none',
  	"fallback_code" varchar,
  ...
  CREATE TABLE "ad_events" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"ad_id" integer,
  	"event_type" "enum_ad_events_event_type" NOT NULL,
  	"placement" varchar,
  	"page_url" varchar,
  	"user_agent" varchar,
  	"ip_hash" varchar,
  ...
  CREATE TABLE "settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'PorosMadura',
  	"site_description" varchar,
  	"tagline" varchar DEFAULT 'Berita Tepat, Fakta Kuat',
  	"site_url" varchar,
  	"logo_id" integer,
  	...
  	"default_seo_title" varchar DEFAULT 'PorosMadura',
  	"default_seo_description" varchar DEFAULT 'Berita Tepat, Fakta Kuat',
  	"google_analytics_id" varchar,
  	"rss_title" varchar DEFAULT 'PorosMadura',
  	"rss_description" varchar DEFAULT 'Berita Tepat, Fakta Kuat',
  	"news_publication_name" varchar DEFAULT 'PorosMadura',
  ...
  ALTER TABLE "ads" ADD CONSTRAINT "ads_image_desktop_id_media_id_fk" FOREIGN KEY ("image_desktop_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "ads" ADD CONSTRAINT "ads_image_mobile_id_media_id_fk" FOREIGN KEY ("image_mobile_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "ad_events" ADD CONSTRAINT "ad_events_ad_id_ads_id_fk" FOREIGN KEY ("ad_id") REFERENCES "public"."ads"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_ad_events_fk" FOREIGN KEY ("ad_events_id") REFERENCES "public"."ad_events"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "ads_image_desktop_idx" ON "ads" USING btree ("image_desktop_id");
  CREATE INDEX "ads_image_mobile_idx" ON "ads" USING btree ("image_mobile_id");
  ...
  CREATE UNIQUE INDEX "ad_slots_placement_idx" ON "ad_slots" USING btree ("placement");
  ...
  CREATE INDEX "ad_events_ad_idx" ON "ad_events" USING btree ("ad_id");
  CREATE INDEX "ad_events_updated_at_idx" ON "ad_events" USING btree ("updated_at");
  CREATE INDEX "ad_events_created_at_idx" ON "ad_events" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_ad_events_id_idx" ON "payload_locked_documents_rels" USING btree ("ad_events_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_ad_slots_fallback_type";
  DROP TYPE "public"."enum_ad_events_event_type";`)
}
